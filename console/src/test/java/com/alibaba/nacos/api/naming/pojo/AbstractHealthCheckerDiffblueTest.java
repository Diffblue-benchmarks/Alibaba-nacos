...
public class AbstractHealthCheckerDiffblueTest {
  ...
  public void testHttpEquals() {
    ...
    // Act and Assert
    assertFalse(http.equals(new AbstractHealthChecker.Http()));
  }

  @Test
  public void testHttpEquals2() {
    // Arrange
    AbstractHealthChecker.Http http = new AbstractHealthChecker.Http();
  ...
  @Test
  public void testHttpEquals3() {
    // Arrange, Act and Assert
    assertFalse((new AbstractHealthChecker.Http()).equals(""));
  }

  @Test
  public void testHttpEquals4() {
    // Arrange
    AbstractHealthChecker.Http http = new AbstractHealthChecker.Http();

    // Act and Assert
    assertTrue(http.equals(new AbstractHealthChecker.Http()));
  }
  ...
  @Test
  public void testMysqlEquals2() {
    // Arrange
    AbstractHealthChecker.Mysql mysql = new AbstractHealthChecker.Mysql();
    mysql.setUser("MYSQL");

    // Act and Assert
    assertFalse(mysql.equals(new AbstractHealthChecker.Mysql()));
  }

  @Test
  public void testMysqlEquals3() {
    // Arrange
    AbstractHealthChecker.Mysql mysql = new AbstractHealthChecker.Mysql();

    // Act and Assert
    assertTrue(mysql.equals(new AbstractHealthChecker.Mysql()));
  }

  @Test
  public void testMysqlEquals4() {
    // Arrange
    AbstractHealthChecker.Mysql mysql = new AbstractHealthChecker.Mysql();
    mysql.setPwd("MYSQL");

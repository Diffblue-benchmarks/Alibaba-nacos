...
public class NacosExceptionDiffblueTest {
  ...
  public void testSetErrCode() {
    ...
    // Assert
    assertEquals("ErrCode:1, ErrMsg:", nacosException.toString());
  }
  ...
  public void testToString() {
    // Arrange, Act and Assert
    assertEquals("ErrCode:1, ErrMsg:errMsg", (new NacosException(1, "errMsg")).toString());
  }
  ...
  public void testToString3() {
    // Arrange, Act and Assert
    assertEquals("ErrCode:1, ErrMsg:null", (new NacosException(1, new Throwable())).toString());
  }
}

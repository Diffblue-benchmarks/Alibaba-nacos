...
public class OverrideParameterRequestWrapperDiffblueTest {
  ...
  public void testBuildRequest2() {
    ...
    assertFalse(OverrideParameterRequestWrapper.buildRequest(new MockHttpServletRequest()).isTrailerFieldsReady());
  }
  ...
  public void testConstructor2() {
    // Arrange, Act and Assert
    assertFalse((new OverrideParameterRequestWrapper(new OverrideParameterRequestWrapper(new MockHttpServletRequest())))

...
public class KeyBuilderDiffblueTest {
  ...
  public void testBuildInstanceListKey() {
    // Arrange
    String actualBuildInstanceListKeyResult = KeyBuilder.buildInstanceListKey("123", "", true);

    // Act and Assert
    assertEquals("com.alibaba.nacos.naming.iplist.ephemeral.123##", actualBuildInstanceListKeyResult);
    assertEquals("com.alibaba.nacos.naming.iplist.123##", KeyBuilder.buildInstanceListKey("123", "", false));
  }

  @Test
  public void testBuildServiceMetaKey() {
    // Arrange, Act and Assert
    assertEquals("com.alibaba.nacos.naming.domains.meta.123##", KeyBuilder.buildServiceMetaKey("123", ""));
  }
  ...
  public void testMatchInstanceListKey() {
    // Arrange
    boolean actualMatchInstanceListKeyResult = KeyBuilder.matchInstanceListKey("", "123", "");
    ...
    assertFalse(KeyBuilder.matchInstanceListKey("iplist.", "123", ""));
  }
  ...
  public void testMatchServiceMetaKey2() {
    // Arrange
    boolean actualMatchServiceMetaKeyResult = KeyBuilder.matchServiceMetaKey("", "123", "");

    // Act and Assert
    assertFalse(actualMatchServiceMetaKeyResult);
    assertFalse(KeyBuilder.matchServiceMetaKey("com.alibaba.nacos.naming.domains.meta.", "123", ""));
  }

  @Test
  public void testMatchServiceName() {
    // Arrange, Act and Assert
    assertFalse(KeyBuilder.matchServiceName("", "123", ""));
  }

...
public class SwitchDomainDiffblueTest {
  ...
  public void testSetAdWeightMap() {
    ...
    assertEquals("{\"adWeightMap\":{\"foo\":1},\"checkTimes\":3,\"checksum\""
        + ":\"\",\"clientBeatInterval\":42,\"defaultCacheMillis\""
        + ":3000,\"defaultInstanceEphemeral\":true,\"defaultPush"
        + "CacheMillis\":3,\"disableAddIP\":false,\"distroEnabled"
        + "\":true,\"distroServerExpiredMillis\":3,\"distroThreshold"
        + "\":0.7,\"enableAuthentication\":true,\"enableStandalone"
        + "\":true,\"healthCheckEnabled\":true,\"healthCheckWhiteList"
        + "\":[\"foo\"],\"httpHealthParams\":{\"factor\":0.85,\"max\""
        + ":5000,\"min\":500},\"incrementalList\":[\"foo\"],\"limitedUrlMap"
        + "\":{\"foo\":1},\"masters\":[\"foo\"],\"mysqlHealthParams\":"
        + "{\"factor\":0.65,\"max\":3000,\"min\":2000},\"name\":\"00-00"
        + "---000-NACOS_SWITCH_DOMAIN-000---00-00\",\"overridde"
        + "nServerStatus\":\"0.1.0\",\"pushCVersion\":\"0.8.9\"," + "\"pushEnabled\":true,\"pushGoVersion\":\"0.8.9\","
        + "\"pushJavaVersion\":\"0.8.9\",\"pushPythonVersion\":\"0.8"
        + ".9\",\"sendBeatOnly\":false,\"serverStatusSynchronizat"
  ...
  public void testSetClientBeatInterval() {
    // Arrange and Act
    this.switchDomain.setClientBeatInterval(42L);

    // Assert
    assertEquals(42L, this.switchDomain.getClientBeatInterval());
  }
  ...
  public void testSetHealthCheckWhiteList() {
    ...
    // Assert
    assertEquals("{\"adWeightMap\":{},\"checkTimes\":3,\"checksum\":\"\","
        + "\"clientBeatInterval\":42,\"defaultCacheMillis\":3000,"
        + "\"defaultInstanceEphemeral\":true,\"defaultPushCacheMillis"
  ...
  public void testSetHttpHealthParams() {
    ...
    assertEquals("{\"adWeightMap\":{},\"checkTimes\":3,\"checksum\":\"\","
        ...
        + "\"pushJavaVersion\":\"0.8.9\",\"pushPythonVersion\":\"0.4"
  ...
  public void testSetMasters() {
    ...
    assertEquals("{\"adWeightMap\":{},\"checkTimes\":3,\"checksum\":\"\","
        ...
        + "\"factor\":0.65,\"max\":3000,\"min\":2000},\"name\":\"00-00"
        + "---000-NACOS_SWITCH_DOMAIN-000---00-00\",\"overridde"
        + "nServerStatus\":\"\",\"pushCVersion\":\"1.0.12\",\"pushEnabled"
  ...
  public void testSetPushCVersion() {
    // Arrange and Act
    this.switchDomain.setPushCVersion("0.8.9");

    // Assert
    assertEquals("0.8.9", this.switchDomain.getPushCVersion());
  }
  ...
  public void testSetPushGoVersion() {
    // Arrange and Act
    this.switchDomain.setPushGoVersion("0.8.9");

    // Assert
    assertEquals("0.8.9", this.switchDomain.getPushGoVersion());
  }

  @Test
  public void testSetPushJavaVersion() {
    // Arrange and Act
    this.switchDomain.setPushJavaVersion("0.8.9");

    // Assert
    assertEquals("0.8.9", this.switchDomain.getPushJavaVersion());
  }

  @Test
  public void testSetPushPythonVersion() {
    // Arrange and Act
    this.switchDomain.setPushPythonVersion("0.8.9");

    // Assert
    assertEquals("0.8.9", this.switchDomain.getPushPythonVersion());
  }

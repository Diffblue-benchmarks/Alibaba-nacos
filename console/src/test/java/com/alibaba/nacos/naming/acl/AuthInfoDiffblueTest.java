...
public class AuthInfoDiffblueTest {
  ...
  public void testFromString() {
    // Arrange
    AuthInfo actualFromStringResult = AuthInfo.fromString(",", "UTF-8");
    AuthInfo actualFromStringResult1 = AuthInfo.fromString(":", "UTF-8");

    // Act and Assert
    assertNull(actualFromStringResult);
    assertNull(actualFromStringResult1);
    assertNull(AuthInfo.fromString(",", ","));
  }
  ...
  public void testSetAppKey() {
    ...
    // Assert
    assertEquals("-111,-118,-109,-109,-59,-45", authInfo.toString());
  }

...
public class RaftCoreDiffblueTest {
  ...
  public void testBuildURL() {
    // Arrange
    String actualBuildURLResult = RaftCore.buildURL("127.0.0.1", ",");

    // Act and Assert
    assertEquals("http://127.0.0.1:0/nacos,", actualBuildURLResult);
  ...
  public void testIsLeader() {
    // Arrange, Act and Assert
    assertFalse(this.raftCore.isLeader("127.0.0.1"));
  }
  @Test

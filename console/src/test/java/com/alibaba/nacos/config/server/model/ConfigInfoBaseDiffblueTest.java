...
public class ConfigInfoBaseDiffblueTest {
  ...
  public void testCompareTo3() {
    // Arrange, Act and Assert
    assertEquals(0, (new ConfigInfoBase("123", "group", null)).compareTo(new ConfigInfoBase("123", "group", null)));
  }
  ...
  public void testCompareTo4() {
    // Arrange, Act and Assert
    assertEquals(0,
        (new ConfigInfoBase("123", "group", "content")).compareTo(new ConfigInfoBase("123", "group", "content")));
  }
  ...
  public void testHashCode2() {
    // Arrange, Act and Assert
    assertEquals(-593540371, (new ConfigInfoBase("123", "group", "content")).hashCode());
  }

...
public class AsyncNotifyServiceDiffblueTest {
  ...
  public void testNotifySingleTaskConstructor() {
    // Arrange and Act
    AsyncNotifyService.NotifySingleTask actualNotifySingleTask = new AsyncNotifyService.NotifySingleTask("123", "&tag=",
        "", 1L, "&tag=");

    // Assert
    assertEquals("123", actualNotifySingleTask.getDataId());
    assertEquals("http://&tag=null/v1/cs/communication/dataChange" + "?dataId=123&group=%26tag%3D",
  ...
  public void testNotifySingleTaskConstructor2() {
    ...
    // Assert
    assertEquals("123", actualNotifySingleTask.getDataId());
    assertEquals("http://&tag=null/v1/cs/communication/dataChange" + "?dataId=123&group=%26tag%3D&tenant=&tag=",
        actualNotifySingleTask.url);
    assertEquals(1L, actualNotifySingleTask.getLastModified());
  ...
  public void testNotifySingleTaskConstructor3() {
    ...
    assertEquals("123", actualNotifySingleTask.getDataId());
    assertEquals(
        "http://&tag=null/v1/cs/communication/dataChange" + "?dataId=123&group=%26tag%3D&tenant=&tag=&tag=&tag=",
        actualNotifySingleTask.url);
    assertEquals(1L, actualNotifySingleTask.getLastModified());
    assertEquals("&tag=", actualNotifySingleTask.getTenant());
    assertEquals(0, actualNotifySingleTask.getFailCount());
  ...
  public void testNotifySingleTaskSetFailCount() {
    // Arrange
    AsyncNotifyService.NotifySingleTask notifySingleTask = new AsyncNotifyService.NotifySingleTask("123", "&tag=",
        "&tag=", 1L, "&tag=");
